...
def main():
    ...
    while True:
        #Tang toc va chay theo kim dong ho
        if GPIO.input(BT1) == 0:
            print("Press BT1")
            if currentPWD1 != 0:
            ...
            print("Toc do hien tai la: " + str(currentPWD1) + "theo chieu thuan")
            currentPWD2 = 0
            time.sleep(0.5)
        if GPIO.input(BT2) == 0:
            print("Press BT2")
